...
if ($data['mode'] === 'update'): 
   require_once WECOZA_CHILD_DIR . '/app/Views/components/class-capture-partials/update-class.php';
else:
   require_once WECOZA_CHILD_DIR . '/app/Views/components/class-capture-partials/create-class.php';
endif; ?>
