...
<div id="page" class="site">
  ...
  <header id="masthead" class="<?= apply_filters('bootscore/class/header', 'sticky-top navbar-top'); ?> site-header">
    ...
    <nav id="nav-main" class="navbar <?= apply_filters('bootscore/class/header/navbar/breakpoint', 'navbar-expand-lg'); ?>">
      ...
      <div class="<?= apply_filters('bootscore/class/container', 'container', 'header'); ?>">
        ...
        <a class="<?= apply_filters('bootscore/class/header/navbar-brand', 'navbar-brand'); ?>" href="<?= esc_url(home_url()); ?>">
          <img src="<?= esc_url(apply_filters('bootscore/logo', get_stylesheet_directory_uri() . '/assets/img/logo/wecoza-logo-dark.png', 'default')); ?>" alt="<?php bloginfo('name'); ?> Logo" class="d-td-none">
          <img src="<?= esc_url(apply_filters('bootscore/logo', get_stylesheet_directory_uri() . '/assets/img/logo/wecoza-logo-light.png', 'theme-dark')); ?>" alt="<?php bloginfo('name'); ?> Logo" class="d-tl-none">
        </a>  
