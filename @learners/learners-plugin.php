 ...
 * Text Domain: wecoza-learners
 * Domain Path: /languages
 * 
 * @package WeCoza_Learners
 * 
 * NOTE: This is a prepared plugin structure. To activate as a plugin:
 * 1. Move this entire @learners folder to wp-content/plugins/wecoza-learners/
...
class WeCoza_Learners_Plugin {
    ...
    public function init() {
        ...
        load_plugin_textdomain('wecoza-learners', false, dirname(WECOZA_LEARNERS_PLUGIN_BASENAME) . '/languages');
    }
