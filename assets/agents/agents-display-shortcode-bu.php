<?php
   function wecoza_display_agents_shortcode() {
       ...
       // wp_enqueue_script('learners-display-script', WECOZA_CHILD_URL . '/assets/learners/js/learners-display-shortcode.js', array('jquery'), WECOZA_PLUGIN_VERSION, true);
...
<div class="modal-content">
   ...
   <div class="modal-body ydcoza-compact-content" id="modalContent">
      ...
      <div class="gtabs ydcoza-tab mb-3">
         ...
         <!-- Offcanvas for Agent History (similar to "Learner History") -->
         <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasHistory" aria-labelledby="offcanvasHistoryLabel">
            <div class="container">
               <div class="offcanvas-header pb-2 pt-2 border-bottom">
                  <h5 class="offcanvas-title" id="offcanvasHistoryLabel">Agent History</h5>
                  ...
                  <div class="row px-3">
                     <div class="col">
                        <p class="border-bottom pb-2 mb-2">
                           <span class="ydcoza-strong">Class:</span> ENG 01, 
                           <span class="ydcoza-strong">Client:</span> TechCorp B1, 
                           <span class="ydcoza-strong">Facilitator:</span> Sarah Lee 
                           <span class="ydcoza-strong">Class ID:</span> <a href="#" target="_blank">#482930</a>
                        </p>
                        <p class="border-bottom pb-2 mb-2">
                           <span class="ydcoza-strong">Class:</span> SCI 03, 
                           <span class="ydcoza-strong">Client:</span> MedLife C3, 
                           <span class="ydcoza-strong">Facilitator:</span> John Smith 
                           <span class="ydcoza-strong">Class ID:</span> <a href="#" target="_blank">#573481</a>
                        </p>
                     </div>
                     <div class="col">
                        <p class="border-bottom pb-2 mb-2">
                           <span class="ydcoza-strong">Class:</span> MATH 04, 
                           <span class="ydcoza-strong">Client:</span> EduWorld X9, 
                           <span class="ydcoza-strong">Facilitator:</span> Alicia Wong 
                           <span class="ydcoza-strong">Class ID:</span> <a href="#" target="_blank">#654782</a>
                        </p>
                        <p class="mb-2">
                           <span class="ydcoza-strong">Class:</span> HIS 02, 
                           <span class="ydcoza-strong">Client:</span> BuildIt G7, 
                           <span class="ydcoza-strong">Facilitator:</span> Mark Johnson 
                           <span class="ydcoza-strong">Class ID:</span> <a href="#" target="_blank">#786594</a>
                        </p>
                     </div>
                  </div>
               </div>
         ...
         <div class="container-fluid gtab tab-4 border-top border-bottom mb-2 lh-1">
            <!-- Possibly show agent’s product-trained start/end dates here -->
            <!--             <div class="row border-start">
               <div class="col-2 border-end p-2 bg-light d-flex align-items-center">Product Trained Start Date</div>
               <div class="col border-end p-2 d-flex align-items-center">2023-01-01</div>
               <div class="col border-end p-2 bg-light d-flex align-items-center">Product Trained End Date</div>
               <div class="col-4 border-end p-2 d-flex align-items-center">2023-06-30</div>
               <div class="col border-end p-2 bg-light d-flex align-items-center">&nbsp;</div>
               <div class="col border-end p-2 d-flex align-items-center">&nbsp;</div>
               <div class="col border-end p-2 bg-light d-flex align-items-center">&nbsp;</div>
               <div class="col p-2 d-flex align-items-center">&nbsp;</div>
            ...
            <!-- Example Offcanvas or Extra Button -->
            <!--             <div class="row border-start border-top">
               <div class="col border-end p-2 bg-light d-flex align-items-center">
                 <button class="btn btn-sm btn-outline-discovery" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasPortfolio" aria-controls="offcanvasPortfolio">
                   Update Agents Progression
                 </button>
               </div> -->
            <!--               <div class="col border-end p-2 d-flex align-items-center">&nbsp;</div>
               <div class="col border-end p-2 bg-light d-flex align-items-center">&nbsp;</div>
            ...
            <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasPortfolio" aria-labelledby="offcanvasPortfolioLabel">
               ...
               <div class="offcanvas-body">
                  <div class="container">
                     ...
                     <!--       <div class="row px-3">
                        <div class="portfolio-links mb-4">
                          <div class="d-flex align-items-center mb-2">
                            <span class="me-3">Portfolio 1 
                              <span class="text-muted ms-2">(2025-01-10)</span>
                            </span>
                            <a href="#" download class="btn btn-sm btn-outline-discovery">Download</a>
                          </div>
                          <div class="d-flex align-items-center mb-2">
                            <span class="me-3">Portfolio 2 
                              <span class="text-muted ms-2">(2025-01-15)</span>
                            </span>
                            <a href="#" download class="btn btn-sm btn-outline-discovery">Download</a>
                          </div>
                        </div>
                        </div> -->
                     <!-- New Form for Dates and Dropdown -->
                     <div class="row px-3">
                        <div class="col-12">
                           <form id="agents-progression-form" class="needs-validation ydcoza-compact-form" novalidate method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row mb-3">
                                 <div class="col-md-4">
                                    ...
                                    Agent product trained start date
                                    </label>
                                    <input type="date" class="form-control form-control-sm" id="startDate" name="startDate"  aria-describedby="startDateHelp">
                                    <small id="startDateHelp" class="form-text text-muted">
                                    This is the start date an agent last trained these products.
                                    </small>
                                 </div>
                                 <div class="col-md-4">
                                    <label for="endDate" class="form-label">
                                    Agent product trained end date
                                    </label>
                                    <input type="date" class="form-control form-control-sm" id="endDate" name="endDate" aria-describedby="endDateHelp">
                                    <small id="endDateHelp" class="form-text text-muted">
                                    This is the end date an agent last trained these products.
                                    </small>
                                 </div>
                                 <!-- Dropdown Select for Training Modules -->
                                 <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="productSelect" name="productSelect">
                                       <option value="" disabled selected>-- Select an option --</option>
                                       <option value="AET Communication level 1 Basic">
                                          AET Communication level 1 Basic
                                       </option>
                                       <option value="AET Communication level 1">
                                          AET Communication level 1
                                       </option>
                                       <option value="AET Communication level 2">
                                          AET Communication level 2
                                       </option>
                                       <option value="AET Communication level 3">
                                          AET Communication level 3
                                       </option>
                                       <option value="AET Communication level 4">
                                          AET Communication level 4
                                       </option>
                                       <option value="AET Numeracy level 1 Basic">
                                          AET Numeracy level 1 Basic
                                       </option>
                                       <option value="AET Numeracy level 1">
                                          AET Numeracy level 1
                                       </option>
                                       <option value="AET Numeracy level 2">
                                          AET Numeracy level 2
                                       </option>
                                       <option value="AET Numeracy level 3">
                                          AET Numeracy level 3
                                       </option>
                                       <option value="AET Numeracy level 4">
                                          AET Numeracy level 4
                                       </option>
                                       <option value="AET level 4 Life Orientation">
                                          AET level 4 Life Orientation
                                       </option>
                                       <option value="AET level 4 Human & Social Sciences">
                                          AET level 4 Human & Social Sciences
                                       </option>
                                       <option value="AET level 4 Economic & Management Sciences">
                                          AET level 4 Economic & Management Sciences
                                       </option>
                                       <option value="AET level 4 Natural Sciences">
                                          AET level 4 Natural Sciences
                                       </option>
                                       <option value="AET level 4 Small Micro Medium Enterprises">
                                          AET level 4 Small Micro Medium Enterprises
                                       </option>
                                       <option value="REALLL Communication">
                                          REALLL Communication
                                       </option>
                                       <option value="REALLL Numeracy">
                                          REALLL Numeracy
                                       </option>
                                       <option value="REALLL Finance">
                                          REALLL Finance
                                       </option>
                                       <option value="Business Admin NQF 2 - LP1">
                                          Business Admin NQF 2 - LP1
                                       </option>
                                       <option value="Business Admin NQF 2 - LP2">
                                          Business Admin NQF 2 - LP2
                                       </option>
                                       <option value="Business Admin NQF 2 - LP3">
                                          Business Admin NQF 2 - LP3
                                       </option>
                                       <option value="Business Admin NQF 2 - LP4">
                                          Business Admin NQF 2 - LP4
                                       </option>
                                       <option value="Business Admin NQF 2 - LP5">
                                          Business Admin NQF 2 - LP5
                                       </option>
                                       <option value="Business Admin NQF 2 - LP6">
                                          Business Admin NQF 2 - LP6
                                       </option>
                                       <option value="Business Admin NQF 2 - LP7">
                                          Business Admin NQF 2 - LP7
                                       </option>
                                       <option value="Business Admin NQF 2 - LP8">
                                          Business Admin NQF 2 - LP8
                                       </option>
                                       <option value="Business Admin NQF 2 - LP9">
                                          Business Admin NQF 2 - LP9
                                       </option>
                                       <option value="Business Admin NQF 2 - LP10">
                                          Business Admin NQF 2 - LP10
                                       </option>
                                       <option value="Business Admin NQF 3 - LP1">
                                          Business Admin NQF 3 - LP1
                                       </option>
                                       <option value="Business Admin NQF 3 - LP2">
                                          Business Admin NQF 3 - LP2
                                       </option>
                                       <option value="Business Admin NQF 3 - LP3">
                                          Business Admin NQF 3 - LP3
                                       </option>
                                       <option value="Business Admin NQF 3 - LP4">
                                          Business Admin NQF 3 - LP4
                                       </option>
                                       <option value="Business Admin NQF 3 - LP5">
                                          Business Admin NQF 3 - LP5
                                       </option>
                                       <option value="Business Admin NQF 3 - LP6">
                                          Business Admin NQF 3 - LP6
                                       </option>
                                       <option value="Business Admin NQF 3 - LP7">
                                          Business Admin NQF 3 - LP7
                                       </option>
                                       <option value="Business Admin NQF 3 - LP8">
                                          Business Admin NQF 3 - LP8
                                       </option>
                                       <option value="Business Admin NQF 3 - LP9">
                                          Business Admin NQF 3 - LP9
                                       </option>
                                       <option value="Business Admin NQF 3 - LP10">
                                          Business Admin NQF 3 - LP10
                                       </option>
                                       <option value="Business Admin NQF 3 - LP11">
                                          Business Admin NQF 3 - LP11
                                       </option>
                                       <option value="Business Admin NQF 4 - LP1">
                                          Business Admin NQF 4 - LP1
                                       </option>
                                       <option value="Business Admin NQF 4 - LP2">
                                          Business Admin NQF 4 - LP2
                                       </option>
                                       <option value="Business Admin NQF 4 - LP3">
                                          Business Admin NQF 4 - LP3
                                       </option>
                                       <option value="Business Admin NQF 4 - LP4">
                                          Business Admin NQF 4 - LP4
                                       </option>
                                       <option value="Business Admin NQF 4 - LP5">
                                          Business Admin NQF 4 - LP5
                                       </option>
                                       <option value="Business Admin NQF 4 - LP6">
                                          Business Admin NQF 4 - LP6
                                       </option>
                                       <option value="Business Admin NQF 4 - LP7">
                                          Business Admin NQF 4 - LP7
                                       </option>
                                       <option value="Introduction to Computers">
                                          Introduction to Computers
                                       </option>
                                       <option value="Email Etiquette">
                                          Email Etiquette
                                       </option>
                                       <option value="Time Management">
                                          Time Management
                                       </option>
                                       <option value="Supervisory Skills">
                                          Supervisory Skills
                                       </option>
                                    </select>
                                 </div>
