...
$accordion_copy = '<!-- Row 1 -->
               <div class="container-fluid">
                  <div class="row border-start border-top">
                     <div class="col border-end p-2 bg-light d-flex align-items-center">POE Completed?</div>
                     <div class="col border-end p-2 d-flex align-items-center">No</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Date Completed</div>
                     <div class="col border-end p-2 d-flex align-items-center">N/A</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">POE Received?</div>
                     <div class="col border-end p-2 d-flex align-items-center">No</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Date Completed</div>
                     <div class="col border-end p-2 d-flex align-items-center">N/A</div>
                  </div>
                  <!-- Row 2 -->
                  <div class="row border-start border-top">
                     <div class="col border-end p-2 bg-light d-flex align-items-center">POE Sent to Assesor?</div>
                     <div class="col border-end p-2 d-flex align-items-center">No</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Date Sent</div>
                     <div class="col border-end p-2 d-flex align-items-center">N/A</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">POE Returned</div>
                     <div class="col border-end p-2 d-flex align-items-center">No</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Date Returned</div>
                     <div class="col border-end p-2 d-flex align-items-center">N/A</div>
                  </div>
                  <!-- Row 3 -->
                  <div class="row border-start border-top">
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Result</div>
                     <div class="col border-end p-2 d-flex align-items-center">Not Competent</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Dispatched to Client</div>
                     <div class="col border-end p-2 d-flex align-items-center">N/A</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Date Dispatched</div>
                     <div class="col border-end p-2 d-flex align-items-center">N/A</div>
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Received By</div>
                     <div class="col border-end p-2 d-flex align-items-center">John Doe</div>
                  </div>
                  <!-- Row 4 -->
                  <div class="row border-start border-top  border-bottom">
                     <div class="col border-end p-2 bg-light d-flex align-items-center">Waybill No.</div>
                     <div class="col border-end p-2 d-flex align-items-center">N/A</div>
   ...
   <div class="accordion accordion-flush ml-0 mr-2" style="margin:0 -12px" id="accordionFlush">
      <div class="accordion-item">
         <h2 class="accordion-header">
            <button class="accordion-button collapsed btn btn-light border-start border-end" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">POE | Class #1313 | 2023/09/26</button>
         </h2>
...
$return .= '</div>
      ...
      <div class="accordion-item">
         <h2 class="accordion-header">
            <button class="accordion-button collapsed btn ydcoza-text-warning border-start border-end" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">POE Not Completed | Class #6478 | 2022/07/11</button>
         </h2>
...
$return .= '</div>
      ...
      <div class="accordion-item">
         <h2 class="accordion-header">
            <button class="accordion-button collapsed btn btn-light border-start border-end" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">POE | Class #1113 |2021/11/01</button>
         </h2>
